...
const NewsCard = ({ news }) => {
    const { title, thumbnail_url, image_url, details, _id, rating, number, total_view, author, published_date, img, name
    ...
    return (
        ...
        <div>
            ...
            <div className="relative flex w-full max-w-full flex-col  bg-gray-200 bg-clip-border text-gray-700 shadow-lg mb-10 border">
                <div className="flex py-4 justify-between px-5 bg-[#F3F3F3]">
                ...
                <h5 className="block font-sans text-xl  leading-snug tracking-normal text-blue-gray-900 antialiased px-5 font-bold pt-3">
                    {title}
                </h5>
                ...
                <div className="p-6">
                    ...
                    <p className="block font-sans text-base font-light leading-relaxed text-gray-700 antialiased">
                        {
                            details.length > 200
                                ? <h1>{details.slice(0, 200)} <Link className="text-blue-600 font-bold" to={`/news/${_id}`}>Read More...</Link></h1>
                                :
                                <h1>{details}</h1>
